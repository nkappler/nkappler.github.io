...
window.onload = function () {
    ...
    ReactDOM.render(
        <div className="splitter">
            <div className="item glasspane">
                <h1>Stay tuned!</h1>
                <img src="./dist/img/tired.png" />
                <p>This website will be ready soon...</p>
            </div>
            <div className="item">
                <h2 className="glasspane">Contact me</h2>
                ...
                <p className="glasspane" id="sent" style={{ display: "none" }}>Thank you. Your message has been sent.</p>
            </div>
        </div>
